...
export const campaignSpamConfig = createCampaignSpamConfig({
  ...
  slowFloodWindowSeconds: env.CAMPAIGN_SPAM_SLOW_FLOOD_WINDOW_SECONDS,
  slowFloodAuthorThreshold: env.CAMPAIGN_SPAM_SLOW_FLOOD_AUTHOR_THRESHOLD,
  slowFloodChatThreshold: env.CAMPAIGN_SPAM_SLOW_FLOOD_CHAT_THRESHOLD,
